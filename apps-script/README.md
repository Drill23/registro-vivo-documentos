# Registros de Documentos - Google Apps Script

Este script transforma uma planilha Google em banco de dados e tambem hospeda o app Registros de Documentos pelo proprio Google Apps Script.
